...
wp_register_style( 'Lazy-Loader-CSS', home_url().'/wp-content/plugins/lazy_loader/assets/lazy_loader.css' ); 
wp_enqueue_style('Lazy-Loader-CSS');
wp_register_script( 'Lazy-Loader-JS', home_url().'/wp-content/plugins/lazy_loader/assets/jquery.min.js' ); 
...
$autoloader_img=home_url().'/wp-content/plugins/lazy_loader/images/loader.gif';
$data='<ul id="posts"></ul>
